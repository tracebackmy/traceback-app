...
export default function ReportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create the final document with image URLs
      ...
      if (error instanceof Error) {
        setError(error.message || 'Failed to report item')
      } else {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Help reunite people with their lost belongings</p>
      </div>
